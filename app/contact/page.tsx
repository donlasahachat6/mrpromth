        ...
        <div>
          <section className="mb-8">
            ...
            <p className="text-gray-700 mb-6">
              ...
              กรุณากรอกแบบฟอร์มด้านขวา หรือติดต่อเราผ่านช่องทางด้านล่าง
            </p>
          </section>
            ...
            <div className="space-y-4">
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-600">support@mrprompt.com</p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-600">เสาร์ - อาทิตย์: ปิดทำการ</p>
                </div>
              </div>
            </div>
          </section>
          ...
          <section>
            ...
            <div className="flex space-x-4">
              ...
              <a href="https://github.com/donlasahachat6/mrpromth" className="text-gray-600 hover:text-blue-600 transition">
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
